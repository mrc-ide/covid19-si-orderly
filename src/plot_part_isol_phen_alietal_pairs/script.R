...
p <- p +
  geom_table_npc(
    ...
    table.theme = ttheme_gtminimal()
        ...
        "Estimated using discrete transmission pairs with solation for some pairs",
        subtitle = "Infectious period assumed to be phenomenologically distributed"
      )

ggsave("part_isol_phen_alietal_pairs.png", p)
